<template>
  ...
  >
    <h1 class="text-4xl md:text-6xl font-bold text-lighter">Contact</h1>
    <!-- <form action="/thank-you" class="rounded-2xl border border-light p-6 mt-6">
      <h2 class="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
          <svg viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="h-12 w-12 flex-none">
